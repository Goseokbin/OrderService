...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findOrderQueryDtos() {
        ...
        orders.forEach(o -> {
            List<OrderItemQueryDto> orderItems = findOrderItems(o.getOrderId()); //쿼리 n번 발생.
    ...
    private List<OrderItemQueryDto> findOrderItems(Long orderId) {
        return em.createQuery("select new jpabook.jpashop.repository.order.query.OrderItemQueryDto(oi.order.id, i.name," +
